...
urlpatterns = [
    ...
    path('app/tambah-data-bus/', views.add_bus, name='add_bus'),
    path('app/edit-data-bus/<int:pk>/', views.edit_bus, name='edit_bus'),
    re_path(r'^app/barat-timur*\.*', views.barat_timur, name='barat_timur'),
    re_path(r'^app/timur-barat*\.*', views.timur_barat, name='timur_barat'),
    re_path(r'^app/data-bus*\.*', views.pencarian_bus, name='data_bus'),
